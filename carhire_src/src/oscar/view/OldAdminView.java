 ...
 */
public class OldAdminView extends FrameView implements ActionListener {

    /**
     * Class constructor
     * @param app The application
     */
    public OldAdminView(SingleFrameApplication app) {
        super(app);
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(OldAdminView.class, this);
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(OldAdminView.class);
